...
void PAM(struct vec *, struct vec *, struct h_func **h, struct list_node ***HashTables, int *, int, int, int, int, int);
void PAMean(struct vec *, struct vec *, struct h_func **h, struct list_node ***HashTables, int *, int, int, int, int, int);
