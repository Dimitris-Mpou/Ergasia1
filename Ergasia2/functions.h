...
void LSH_assignment(struct vec *, struct vec *, struct h_func **h, struct list_node ***HashTables, int *, int, int, int);
void PAM(struct vec *, struct vec *, struct h_func **h, struct list_node ***HashTables, int *, int, int, int);
void PAMean(struct vec *, struct vec *, struct h_func **h, struct list_node ***HashTables, int *, int, int, int);
...
double min_range(struct vec *, int, int);
