...
void lsh_train(struct vec *, struct h_func **, int *, unsigned int **, int, int, int, int, int, int);
void lsh_search(struct vec, struct h_func **, int *, unsigned int *, int, int, int, int, int)
